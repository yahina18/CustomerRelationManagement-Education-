...
String SELECT_QUERY = "SELECT o.date_of_purchase, c.description, c.image_url, c.name, c.updated_on FROM orders o JOIN courses c ON o.course_name=c.name WHERE o.user_email=:email";
